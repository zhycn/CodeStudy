...
好的，我对您提供的优秀教程目录进行了重新分组和排序。新的结构遵循了从基础到精通、从语言核心到生态系统、从通用知识到专业领域的自然学习路径，并参考了Java官方教程的组织逻辑。
...
### 函数式编程与流处理 (Functional Programming & Streams)
...
- [Java JDK 命令行工具详解与最佳实践](./java-jdk-tools.md)
